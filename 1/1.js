...
Советую округлить значение после рассчетов, так как в некоторых случаях может получиться 
"длинная дробь".*/
...
let tf = convertToFahrenheit(tc);

alert(`Температура ${tc} град. по Цельсию соответствует ${tf.toFixed(1)} град. по Фаренгейту`);
